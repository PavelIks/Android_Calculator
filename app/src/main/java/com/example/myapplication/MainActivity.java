    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        findViewById(R.id.button34).setOnClickListener(new Button.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                {
                    ((TextView)findViewById(R.id.editTextTextPersonName)).setText(((TextView)findViewById(R.id.editTextTextPersonName)).getText().toString() + ((Button)findViewById(R.id.button34)).getText().toString());
                }
            }
        });
